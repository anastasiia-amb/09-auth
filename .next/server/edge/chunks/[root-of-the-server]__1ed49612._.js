(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/[root-of-the-server]__1ed49612._.js",
...
"[project]/09-auth/lib/api/api.ts [middleware-edge] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$09$2d$auth$2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/09-auth/node_modules/axios/lib/axios.js [middleware-edge] (ecmascript)");
;
const nextServer = __TURBOPACK__imported__module__$5b$project$5d2f$09$2d$auth$2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].create({
    baseURL: ("TURBOPACK compile-time value", "http://localhost:3000") + "/api",
    withCredentials: true
});
}),
"[project]/09-auth/lib/api/serverApi.ts [middleware-edge] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$09$2d$auth$2f$lib$2f$api$2f$api$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/09-auth/lib/api/api.ts [middleware-edge] (ecmascript)");
;
;
const checkServerSession = async ()=>{
    ...
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$09$2d$auth$2f$lib$2f$api$2f$api$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["nextServer"].get("/auth/session", {
        headers: {
...
const getServerMe = async ()=>{
    const cookieStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$09$2d$auth$2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$request$2f$cookies$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["cookies"])();
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$09$2d$auth$2f$lib$2f$api$2f$api$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["nextServer"].get("/users/me", {
        headers: {
            Cookie: cookieStore.toString()
        }
    });
...
const fetchServerNotes = async (page, query, tag)=>{
    const cookieStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$09$2d$auth$2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$request$2f$cookies$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["cookies"])();
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$09$2d$auth$2f$lib$2f$api$2f$api$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["nextServer"].get("/notes", {
        params: {
            page: page,
            perPage: 12,
            search: query,
...
const fetchServerNoteById = async (id)=>{
    const cookieStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$09$2d$auth$2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$request$2f$cookies$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["cookies"])();
    const response = await __TURBOPACK__imported__module__$5b$project$5d2f$09$2d$auth$2f$lib$2f$api$2f$api$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["nextServer"].get(`/notes/${id}`, {
        headers: {
            "Content-Type": "application/json",
            Cookie: cookieStore.toString()
        }
...
var __TURBOPACK__imported__module__$5b$project$5d2f$09$2d$auth$2f$lib$2f$api$2f$serverApi$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/09-auth/lib/api/serverApi.ts [middleware-edge] (ecmascript)");
;
;
;
;
...
async function middleware(request) {
    ...
    if (!accessToken) {
        if (refreshToken) {
            ...
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$09$2d$auth$2f$lib$2f$api$2f$serverApi$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["checkServerSession"])();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1ed49612._.js.map