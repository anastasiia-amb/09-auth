...
"[project]/09-auth/components/AuthProvider/AuthProvider.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const AuthProvider = (param)=>{
    let { children } = param;
    _s();
    const setUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$09$2d$auth$2f$lib$2f$store$2f$authStore$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"])({
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$09$2d$auth$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            const fetchUser = {
                "AuthProvider.useEffect.fetchUser": async ()=>{
                    const isAuthenticated = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$09$2d$auth$2f$lib$2f$api$2f$clientApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["checkSession"])();
                    if (isAuthenticated) {
                        const user = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$09$2d$auth$2f$lib$2f$api$2f$clientApi$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getMe"])();
...
//# sourceMappingURL=09-auth_9dfd5e0b._.js.map