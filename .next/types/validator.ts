...
{
  const handler = {} as typeof import("..\\..\\app\\(auth routes)\\sing-in\\page.js")
  handler satisfies AppPageConfig<"/sing-in">
}

// Validate ..\..\app\(auth routes)\sing-up\page.tsx
{
  const handler = {} as typeof import("..\\..\\app\\(auth routes)\\sing-up\\page.js")
  handler satisfies AppPageConfig<"/sing-up">
}

// Validate ..\..\app\(private routes)\notes\[id]\page.tsx
{
  const handler = {} as typeof import("..\\..\\app\\(private routes)\\notes\\[id]\\page.js")
